...
computed_property_instances = test_driver(atoms,max_volume_scale=0.1,temperature_K=0,cell_cauchy_stress_eV_angstrom3=[0,0,0,0,0,0])
###############################################################################
...
for i in unique_structure_indices:    
    print ('\nRUNNING TEST DRIVER ON QUERIED STRUCTURE\n')
    computed_property_instances = test_driver(list_of_queried_structures[i],max_volume_scale=0.1)
    # do something with computed_property_instances if you want
